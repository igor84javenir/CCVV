...
INSERT INTO rdvs(name, first_name, phone_number, email, date, time, status, rdv_reason_id, city_id, created_by, modified_by) VALUES ('HUGO', 'Victor', '51 42 33 24 15', 'hugov@gmail.com', '2022-01-30', '15:30', 0, (SELECT id FROM reasons_rdv WHERE name = 'permis de construire'), (SELECT id FROM cities WHERE name = 'Mollans-sur-Ouvèze'),'Système', 'Système');
INSERT INTO rdvs(name, first_name, phone_number, email, date, time, status, rdv_reason_id, city_id, created_by, modified_by) VALUES ('DUMAS', 'Alexandre', '01 02 03 04 05', 'dumasa@gmail.com', '2022-01-31', '11:30', 0, (SELECT id FROM reasons_rdv WHERE name = 'carte grise'), (SELECT id FROM cities WHERE name = 'Saint-Romain-en-Viennois'),'Système', 'Système');
INSERT INTO rdvs(name, first_name, phone_number, email, date, time, status, rdv_reason_id, city_id, created_by, modified_by) VALUES ('VERNE', 'Jules', '11 22 33 44 55', 'vernejr@gmail.com', '2022-01-31', '14:30', 0, (SELECT id FROM reasons_rdv WHERE name = 'permis de construire'), (SELECT id FROM cities WHERE name = 'Mollans-sur-Ouvèze'),'Système', 'Système');
INSERT INTO rdvs(name, first_name, phone_number, email, date, time, status, rdv_reason_id, city_id, created_by, modified_by) VALUES ('VOLTAIRE', 'François-Marie', '11 22 33 44 55', 'voltairefm@gmail.com', '2022-01-20', '14:30', 1, (SELECT id FROM reasons_rdv WHERE name = 'permis de construire'), (SELECT id FROM cities WHERE name = 'Mollans-sur-Ouvèze'),'Système', 'Système');
INSERT INTO rdvs(name, first_name, phone_number, email, date, time, status, rdv_reason_id, city_id, created_by, modified_by) VALUES ('CAMUS', 'Albert', '21 22 23 24 25', 'camusa@gmail.com', '2022-01-31', '15:30', 2, (SELECT id FROM reasons_rdv WHERE name = 'permis de construire'), (SELECT id FROM cities WHERE name = 'Mollans-sur-Ouvèze'),'Système', 'Système');