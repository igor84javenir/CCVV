...
insert into reasons_rdv (category, duration_minutes, link_doc, name, exist) values (1, 240, 'www.link6.com', 'rdv très long de 4h', true);
...
INSERT INTO rdvs(name, first_name, phone_number, mail, no_mail, date, time, status, rdv_reason_id, city_id, created_by, modified_by) VALUES ('VOLTAIRE', 'François-Marie', '11 22 33 44 55', 'voltairefm@gmail.com', false, '2021-11-11', '14:30', 1, (SELECT id FROM reasons_rdv WHERE name = 'permis de construire'), (SELECT id FROM cities WHERE name = 'Mollans-sur-Ouvèze'),'Système', 'Système');
INSERT INTO rdvs(name, first_name, phone_number, mail, no_mail, date, time, status, rdv_reason_id, city_id, created_by, modified_by) VALUES ('DE BALZAC', 'Honoré', '11 22 33 44 55', 'voltairefm@gmail.com', false, '2021-12-12', '10:30', 1, (SELECT id FROM reasons_rdv WHERE name = 'carte grise'), (SELECT id FROM cities WHERE name = 'Saint-Romain-en-Viennois'),'Système', 'Système');
INSERT INTO rdvs(name, first_name, phone_number, mail, no_mail, date, time, status, rdv_reason_id, city_id, created_by, modified_by) VALUES ('PROUST', 'Marcel', '11 22 33 44 55', 'voltairefm@gmail.com', false, '2021-10-10', '09:30', 1, (SELECT id FROM reasons_rdv WHERE name = 'carte de résident'), (SELECT id FROM cities WHERE name = 'Roaix'),'Système', 'Système');
