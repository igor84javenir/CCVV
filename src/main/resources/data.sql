...
insert into reasons_rdv (category, duration_minutes, link_doc, name, exist) values (1, 180, 'www.link6.com', 'rdv très long de 3h', true);
...
INSERT INTO rdvs(name, first_name, phone_number, mail, date, time, status, rdv_reason_id, city_id, created_by, modified_by) VALUES ('SARTRE', 'Jean-Paul', '61 62 63 64 65', 'sartrejp@gmail.com', '2022-03-18', '08:30', 0, (SELECT id FROM reasons_rdv WHERE name = 'rdv très long de 3h'), (SELECT id FROM cities WHERE name = 'Mollans-sur-Ouvèze'),'Système', 'Système');
INSERT INTO rdvs(name, first_name, phone_number, mail, date, time, status, rdv_reason_id, city_id, created_by, modified_by) VALUES ('DE BEAUVOIR', 'Simone', '71 72 73 74 75', 'debeauvoirs@gmail.com', '2022-03-18', '14:15', 0, (SELECT id FROM reasons_rdv WHERE name = 'rdv très long de 3h'), (SELECT id FROM cities WHERE name = 'Saint-Roman-de-Malegarde'),'Système', 'Système');
